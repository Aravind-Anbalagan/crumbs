...
public class IndicatorService {
	...
	public void saveIndicator(Indicator indicator) {
		...
		managed.setHeikinAshiWeekly(indicator.getHeikinAshiWeekly());
		managed.setPsarFlagWeekly(indicator.getPsarFlagWeekly());
		managed.setWeekly_sr_signal(indicator.getWeekly_sr_signal());
		managed.setWeekly_fibo_signal(indicator.getWeekly_fibo_signal());
        managed.setWeeklyvolumeFlag(indicator.getWeeklyvolumeFlag());
