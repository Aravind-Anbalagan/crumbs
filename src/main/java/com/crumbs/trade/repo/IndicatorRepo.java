			    ...
			    WHERE
			        ...
			        (
			            ...
			            (
			                ...
			                (
			                    :isWeekly = false
			                    OR i.psarFlagWeekly IN ('FIRST BUY', 'FIRST SELL')
			                    OR i.heikinAshiWeekly IN ('FIRST BUY', 'FIRST SELL')
			                )
			            )
			        )
			""")
	List<Indicator> findIndicatorsWithFilters(@Param("heikin") String heikin, @Param("psar") String psar,
			@Param("isWeekly") boolean isWeekly, @Param("isCombined") boolean isCombined);
