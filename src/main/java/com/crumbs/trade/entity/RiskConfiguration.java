...
public class RiskConfiguration {
    ...
    // --- NEW: RUNTIME RISK STATE (persisted so restarts don't lose peak/floor tracking) ---
    @Column(name = "current_peak_pnl", precision = 12, scale = 2)
    private BigDecimal currentPeakPnl;

    @Column(name = "current_trailing_floor", precision = 12, scale = 2)
    private BigDecimal currentTrailingFloor;
}